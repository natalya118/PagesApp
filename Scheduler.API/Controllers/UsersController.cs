...
//            IEnumerable<PageViewModel> _usersVM = Mapper.Map<IEnumerable<User>, IEnumerable<PageViewModel>>(_users);
...
//            if (_user != null)
//            {
//                PageViewModel _userVM = Mapper.Map<User, PageViewModel>(_user);
...
//            {
//                IEnumerable<NavLinkViewModel> _userSchedulesVM = Mapper.Map<IEnumerable<Schedule>, IEnumerable<NavLinkViewModel>>(_userSchedules);
...
//        [HttpPost]
//        public IActionResult Create([FromBody]PageViewModel user)
//        {
...
//            user = Mapper.Map<User, PageViewModel>(_newUser);
...
//        [HttpPut("{id}")]
//        public IActionResult Put(int id, [FromBody]PageViewModel user)
//        {
//            if (!ModelState.IsValid)
//            {
//                return BadRequest(ModelState);
...
//            user = Mapper.Map<User, PageViewModel>(_userDb);
